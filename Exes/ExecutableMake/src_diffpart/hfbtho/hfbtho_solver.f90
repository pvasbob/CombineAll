...
Contains
  ...
  Subroutine HFBTHO_DFT_SOLVER()
    ...
    End Do
      ...
      !qrpa_Romega=0.0
      !qrpa_Iomega=1.0
      !qrpa_Romega_step=1.0
      !qrpa_Iomega_step=0.0 
       !
       ...
       !Call qrpa_HFBTHO_solver  !!!: Use hfbtho_version                          ! solve qrpa for this omega
        write(*,*) "After qrpa_HFBTHO_solver"
       End Do


       !===================================================rbmst
       ! allocate and prepare data for rbm.
       !===================================================
       ! execute qrpa_HFBTHO_solver to populate iQROA_LEN
       !---------------------------------------------------
       qrpa_omega = cmplx(0.0, 100.0)
       Call qrpa_HFBTHO_solver                                                   ! solve qrpa for this omega
       !
       write(*,*) 'nuv: ', nuv
       write(*,*) '2*nuv: ', 2*nuv
...
!  !Do i = 1, 9
!  !Do i = 1, 1
!      Write(trainingdata, *) FhN_c(:), FhP_c(:), BFhN_c(:), BFhP_c(:)
!  !End Do
!   ! FAM solutions
   Do i = 1, rbmdim
